      ...
      <script>
        (function() {
          ...
          function botContarPiso(dp){
            ...
            cfg.docs.forEach(function(d){ total++; if(estadoSwitchBot(d.code,idx)==='OK') hechos++; });
            if(cfg.fin){ var fv=finValorBot(mapEst); if(finDespliegaDocs(fv)){ FIN_DOCS_BOT.forEach(function(d){ total++; if(estadoSwitchBot(d.code,idx)==='OK') hechos++; }); } }
