      ...
      <script>
        (function() {
          ...
          function botContarPiso(dp){
            ...
            cfg.docs.forEach(function(d){ if(d.opc) return; total++; if(estadoSwitchBot(d.code,idx)==='OK') hechos++; });
            if(cfg.fin){ var fv=finValorBot(mapEst); if(fv!==''&&fv!=='FFCC'){ FIN_DOCS_BOT.forEach(function(d){ total++; if(estadoSwitchBot(d.code,idx)==='OK') hechos++; }); } }
