  ...
  function cajitaManualHtml({ comu, pisos, expedientes, docsManuales, estadosCcpp, esc, fmtTlf, token }) {
    ...
    <div class="ptl-card ptl-vec-card-manual"
      ...
      <style>
        ...
        .ptl-vec-tabla tbody td { padding: 0 6px !important; font-size: 11px; line-height: 1 !important; height: 18px !important; }
        .ptl-vec-tabla tbody tr { height: 18px !important; }
        .ptl-vec-tabla .ptl-vec-input { padding: 0 6px !important; font-size: 11px; line-height: 1.1 !important; height: 18px !important; box-sizing: border-box; }
