      ...
      <script>
        (function() {
          ...
          function abrirMenuBot(btn){
            ...
            else if(btn.dataset.code==='empadronamiento'){ h+='<button type="button" data-ver="1">Ver documento</button>'; [['OK','OK'],['REVISAR','Revisar'],['INCORRECTO','Incorrecto'],['F','F (falta)'],['VACIO','— vacío —']].forEach(function(o){ h+='<button type="button" data-estado="'+o[0]+'">'+o[1]+'</button>'; }); }
