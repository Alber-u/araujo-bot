...
<html lang="es"><head>
  ...
  const CSS = `
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    /* Variante con celeste más oscuro (timeline) — destaca sin difuminar el texto */
    .ptl-card-timeline{background:#C7D2FE;border-color:#A5B4FC}
    ...
    .ptl-next-action-grid{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:stretch;padding:2px 8px;gap:6px;min-width:0;margin-bottom:6px}
  ...
  function vistaFicha(comu, vecinos, datalists, token, todosExpedientes, reciencreado) {
    ...
    return `
      ...
      <div class="ptl-card ptl-card-timeline" style="display:flex;align-items:center;gap:12px">
