...
<html lang="es"><head>
  ...
  const CSS = `
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-next-action-grid{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:stretch;padding:3px 8px;gap:8px;min-width:0}
    ...
    .ptl-next-action-grid .ptl-na-right{display:flex;flex-direction:column;gap:3px;justify-content:stretch}
    ...
    .ptl-btn-mail-3l{display:flex;flex-direction:column;align-items:center;justify-content:center;line-height:1.15;padding:4px 10px;gap:0;align-self:stretch;height:auto}
    .ptl-btn-mail-3l .ln{display:block;font-size:11px;font-weight:600}
    ...
    /* Responsive del form-grid:
       - >900px:  12 columnas (default arriba)
       - 600-900: 6 columnas, los col-4 quedan en 3 (la mitad), los col-6 quedan en 6 (full)
       - <600px:  todo apilado en 1 columna (móvil estrecho) */
    @media (max-width:900px){
      .ptl-form-grid{grid-template-columns:repeat(6,1fr)}
      .ptl-form-grid .col-1{grid-column:span 1}
      .ptl-form-grid .col-2{grid-column:span 2}
      .ptl-form-grid .col-3{grid-column:span 2}
      .ptl-form-grid .col-4{grid-column:span 3}
      .ptl-form-grid .col-5{grid-column:span 3}
      .ptl-form-grid .col-6{grid-column:span 3}
      .ptl-form-grid .col-7{grid-column:span 6}
      .ptl-form-grid .col-8{grid-column:span 6}
      .ptl-form-grid .col-12{grid-column:span 6}
    }
    @media (max-width:600px){
      .ptl-form-grid{grid-template-columns:1fr}
      .ptl-form-grid [class*=col-]{grid-column:span 1}
    }
  `;
