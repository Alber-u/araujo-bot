    ...
    <div class="ptl-card ptl-vec-card-manual"
      ...
      <script>
        (function() {
          ...
          // Para vacío y para "F" mostramos guión bajo (-), para los demás el valor.
          function textoBoton(estado) {
            if (!estado || estado === 'F') return '·';
            return estado;
          }
          ...
          function actualizarBoton(btn, nuevoEstado) {
            ...
            btn.classList.remove('ptl-vec-doc-btn-rojo', 'ptl-vec-doc-btn-verde');
