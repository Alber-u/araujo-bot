...
<html lang="es"><head>
  ...
  const CSS = `
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-btn-enviar-avanzar{display:flex;flex-direction:column;align-items:center;justify-content:center;line-height:1.1;padding:2px 12px;gap:0;align-self:center;height:auto;white-space:normal}
      ...
      if (fase === "03_ENVIO") {
        accionHtml = `<div class="ptl-next-action ptl-next-action-grid ptl-next-action-grid-2col">
          ...
          <button type="button" class="ptl-btn ptl-btn-primary ptl-btn-enviar-avanzar"
            ...
            <span class="ln">Paso a 04-SEGUIMIENTO PTO</span>
          </button>
        </div>`;
      } else {
