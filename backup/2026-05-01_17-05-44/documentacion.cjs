...
module.exports = function (app) {
  ...
  // =================================================================
  // CAPA DE ACCESO — pestaña pisos (la cajita lee SOLO de aquí)
  // vecinos_base queda fuera de juego: la función leerVecinosBase no
  // se usa actualmente, se conserva para uso futuro.
  // =================================================================
  ...
  // Guarda piso (alta o edición). Escribe SOLO en la pestaña pisos.
  // (Antes esto escribía en vecinos_base y sincronizaba teléfono con expedientes.
  // Ahora la fuente de verdad es la pestaña pisos, y vecinos_base queda fuera.)
