...
const marcoTec = (extra = '') => `
  ...
  <!-- cotas auxiliares perimetrales -->
  <line x1="22" y1="14" x2="22" y2="20" ${stk.aux}/>
  <line x1="254" y1="14" x2="254" y2="20" ${stk.aux}/>
  <line x1="22" y1="16" x2="254" y2="16" ${stk.aux}/>
  <line x1="262" y1="22" x2="268" y2="22" ${stk.aux}/>
  <line x1="262" y1="398" x2="268" y2="398" ${stk.aux}/>
  <line x1="265" y1="22" x2="265" y2="398" ${stk.aux}/>
  <text x="265" y="212" fill="rgba(255,255,255,.5)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="600" letter-spacing=".4" transform="rotate(90 265 212)">H = 26,80 m</text>
  <!-- suelo -->
...
// Líneas auxiliares marcan las plantas; cota indica Ø.
const BLUEPRINT_BAJANTES = `<svg viewBox="0 0 280 420" xmlns="http://www.w3.org/2000/svg" fill="none">
  ${marcoTec(`
    ...
    <!-- pequeña cota de diámetro -->
    <line x1="228" y1="402" x2="228" y2="410" ${stk.aux}/>
    <text x="232" y="412" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".5">Ø 125 PVC-B</text>
  `)}
</svg>`;
...
const BLUEPRINT_CONTADORES = `<svg viewBox="0 0 280 420" xmlns="http://www.w3.org/2000/svg" fill="none">
  ${marcoTec(`
    ...
    <text x="44" y="412" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".5">20 unidades · Ø 25 mm</text>
  `)}
</svg>`;
...
const BLUEPRINT_GRUPO_PRESION = `<svg viewBox="0 0 280 420" xmlns="http://www.w3.org/2000/svg" fill="none">
  ${marcoTec(`
    ...
    <text x="124" y="50" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700">P</text>
    ...
    <text x="48" y="368" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".4">C-1</text>
    <text x="214" y="368" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".4">C-2</text>
  `)}
</svg>`;
...
const BLUEPRINT_CUBIERTAS = `<svg viewBox="0 0 280 420" xmlns="http://www.w3.org/2000/svg" fill="none">
  ${marcoTec(`
    ...
    <!-- cota pendiente -->
    <path d="M70 220 L140 100" ${stk.dim}/>
    <text x="98" y="170" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".5">30 %</text>
    <text x="40" y="412" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".5">Sección Norte-Sur</text>
  `)}
</svg>`;
...
const BLUEPRINT_REPARACIONES = `<svg viewBox="0 0 280 420" xmlns="http://www.w3.org/2000/svg" fill="none">
  ${marcoTec(`
    ...
    <text x="122" y="174" fill="rgba(255,255,255,.6)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".5">Z-1 · INTERVENCIÓN</text>
    <!-- detalle ampliado abajo -->
    <path d="M44 296H236" ${stk.el}/>
    <path d="M140 260V332" ${stk.aux}/>
    <text x="44" y="346" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".4">DETALLE · ESC 1:2</text>
...
const BLUEPRINT_REHABILITACION = `<svg viewBox="0 0 280 420" xmlns="http://www.w3.org/2000/svg" fill="none">
  ${marcoTec(`
    ...
    <text x="22" y="412" fill="rgba(255,255,255,.55)" font-family="Inter,Arial,sans-serif" font-size="6" font-weight="700" letter-spacing=".5">Andamio · UNE-EN 12810</text>
  `)}
</svg>`;
