...
// Logo y sello: logo siempre vectorial SVG (color blanco en cover,
// azul en interior). Sello firmado del CEO usa el PNG real.
...
/* v3.8 · logo SVG (blanco en cover, azul en cabeceras interiores).
   El PNG con cuadrado azul no encajaba sobre fondo navy. */
.cover .marca .logo svg{width:100%;height:100%;display:block}
.pageHead .marca .logo svg{width:100%;height:100%;display:block}
