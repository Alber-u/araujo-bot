      ...
      <form id="ptl-ficha-form" data-id="${esc(comu.ccpp_id)}" onsubmit="return false">
        ...
        <div class="ptl-card">
          ...
          ${(() => {
            ...
            return `
              <div class="ptl-com-list" id="ptlComList" style="height:230px;min-height:80px;overflow-y:auto;resize:vertical;border:1px solid var(--ptl-gray-200);border-radius:5px;background:var(--ptl-general-3)">
                ${filas}
              </div>
