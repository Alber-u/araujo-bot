...
// Build: 2026-06-05 v18.100 (Sobre v18.99: en el panel-esquema de Avisos de resultado se precisa QUE plantilla Twilio avisa al equipo en cada caso: REVISAR -> equipo_revisar_documento (en cada REVISAR); REPETIR -> equipo_intervencion (solo al 3er fallo). Solo display.)
// Build: 2026-06-05 v18.99 (Sobre v18.98: el panel-esquema de Avisos de resultado se reescribe en renglones (vinetas) por columna. Correcciones reales verificadas en codigo: en REPETIR el archivo SI se guarda (marcado REPETIR) pero no cuenta y no avanza; en REVISAR ademas se avisa al equipo (revisar_documento). Solo display.)
