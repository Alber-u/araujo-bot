...
<html lang="es"><head>
  ...
  function vistaPlantillasBotFlujo(plantillas, token) {
    ...
    const cols5 =
      ...
      _col("#2563eb", "🛟 Al equipo — por evento",
