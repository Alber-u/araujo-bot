  ...
  app.get("/presupuestos/hoy", async (req, res) => {
    ...
    try {
      ...
      const _subcabFase = (etiqueta, n) => `
        <div style="display:flex;align-items:center;gap:6px;padding:5px 8px 2px;border-bottom:1px solid var(--ptl-gray-200);font-size:10px;font-weight:700;color:var(--ptl-brand,#4F46E5);text-transform:uppercase;letter-spacing:.4px">
