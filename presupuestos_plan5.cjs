...
<style>
  :root{ --navy:#004079; }
  @page{ size:A4; margin:30mm 14mm 18mm 14mm; @bottom-right{ content: counter(page); font:9pt Cambria,Georgia,serif; color:var(--navy); } }
  *{ box-sizing:border-box; }
  ...
  .dochead{ position:fixed; top:0; left:0; right:0; height:26mm; padding:6mm 14mm 0; }
  .dochead .dhlogo{ height:18mm; width:auto; float:right; }
  .dochead .dhline{ position:absolute; left:14mm; right:14mm; bottom:2mm; border-top:1.6pt solid var(--navy); }
  .docfoot{ position:fixed; bottom:0; left:0; right:0; padding:0 14mm 6mm; }
  .docfoot .dfline{ border-top:1.6pt solid var(--navy); }
  .docfoot .dfnp{ font-size:8.5pt; color:var(--navy); padding-top:2.5px; }
  @media print{
    body{ background:#fff; }
