...
const _P5_REVISION = "Rev-19.3 24/06/2026";
...
module.exports = function (app) {
  ...
  app.get("/plan5/catastro", async function (req, res) {
    ...
    try {
      ...
      if (!rcs.length) return res.json({ ok: false, error: "La via \"" + viaOK + "\" existe, pero el Catastro no devuelve inmuebles en el numero \"" + num + "\". Revisa el numero." });
