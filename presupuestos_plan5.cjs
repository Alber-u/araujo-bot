...
(function(){
  ...
  if(list){ list.querySelectorAll('[data-p5act]').forEach(function(el){ el.addEventListener('click',function(){ var a=el.getAttribute('data-p5act'); if(a==='IMPRIMIR PRESUPUESTO'){ window.open('/plan5/presupuesto'+q(),'_blank'); list.hidden=true; } if(a==='IMPORTAR CATASTRO'){ alert('La busqueda en el Catastro se conectara en el siguiente paso. De momento puedes rellenar la lista a mano.'); list.hidden=true; } }); }); }
})();
`;
...
const _P5_REVISION = "Rev-19.1 23/06/2026";
