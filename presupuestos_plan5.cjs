...
function calcConexion(nsum, tipo, longCon, precios, obra) {
  ...
  const dias = anulaCon ? 0 : diasPorTramo(O.tiempo, lc);      // fontanero = albañil (misma tabla, 1 columna)
  const fc = O.factores;
