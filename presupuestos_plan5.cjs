...
const PLAN5_MENU_JS = `
(function(){
  var SCREENS=[{id:'toma',title:'Toma de datos',route:'/plan5'},{id:'desglose',title:'Desglose de la instalacion',route:'/plan5/desglose'},{id:'precios',title:'Tabla de precios',route:'/plan5/precios'}];
...
module.exports = function (app) {
  ...
  app.get("/plan5/desglose", function (req, res) {
    if (!validToken(req.query.token || "")) return res.status(403).send("token no valido");
    var token = req.query.token || "";
    // De momento el motor no esta conectado: enviamos null y la pantalla muestra el aviso.
    var dsg = null;
