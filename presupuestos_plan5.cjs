...
const _P5_REVISION = "Rev-19.141 28/06/2026";
...
function _p5paginaDocumentacion(R, meta, cuadro, saved){
  ...
  return "<div class='sheet'>"
    + "<style>"
    + ".p5doc .dtit{font-size:14pt;font-weight:800;color:#1f3a8a;margin:0 0 2px}"
    + ".p5doc .dsub{font-size:11pt;font-weight:800;color:#1f3a8a;text-transform:uppercase;margin:0 0 12px}"
    + ".p5doc ol{margin:0;padding-left:22px}"
    + ".p5doc li{margin:0 0 8px;font-size:10.5pt;line-height:1.35}"
    + ".p5doc .nota{font-style:italic;color:#555}"
    + ".p5doc .acta{border-left:3px solid #1f3a8a;background:#f6f8fc;padding:8px 12px;margin:6px 0 2px;font-style:italic;font-size:10pt;line-height:1.45}"
    + ".p5doc .acta p{margin:0 0 7px}.p5doc .acta p:last-child{margin:0}"
    + "</style>"
    + "<div class='p5doc'>"
    + "<div class='dtit'>DOCUMENTACIÓN (de la Comunidad)</div>"
    + "<div class='dsub'>Documentación necesaria</div>"
    + "<ol>"
