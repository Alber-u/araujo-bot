...
const _P5_REVISION = "Rev-19.96 28/06/2026";
...
function _p5paginaImpresoEmasesa(R, meta, saved){
  ...
  .p5emasesa .emsec{border-top:1.3px solid #000;padding:7px 9px}
  .p5emasesa .emrow{display:flex;align-items:flex-end;margin:0;padding-top:15px}
  ...
  .p5emasesa .emchk{display:flex;align-items:flex-start;gap:8px;margin:7px 0}
  .p5emasesa .emcb{width:15px;height:15px;border:1.3px solid #000;flex:0 0 auto;margin-top:1px}
  .p5emasesa .emnota{font-size:8.7px;line-height:1.3;text-align:justify;margin:7px 0}
  .p5emasesa .eminfo{margin:9px 0 4px}
  .p5emasesa .embullets div{display:flex;gap:8px;margin:5px 0;text-align:justify}
  .p5emasesa .emfirma-l{text-align:center;margin:12px 0 2px}.p5emasesa .emfirma-l b{text-transform:uppercase}
  .p5emasesa .emfirma-r{text-align:center;margin:16px 0 0}
  .p5emasesa .emlegal{font-style:italic;font-size:7.6px;line-height:1.3;color:#222;text-align:justify;margin-top:14px}
