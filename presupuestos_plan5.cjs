...
//   * La Y (menor) la manda el MOTOR (Claude). Se sube de uno en uno en CADA entrega/cambio.
...
// ====================================================================================
const _P5_REVISION = "Rev-20.2 30/06/2026";
