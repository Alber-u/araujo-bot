...
const _P5_REVISION = "Rev-19.92 28/06/2026";
...
function renderPresupuesto(R, meta, dsg, cuadro, saved, docsGP){
  ...
  var tabla = _p5tablaPresupuesto(dsg, cuadro, {conex:_matConexTxt, alim:_matAlimTxt, diamGP:_diamGP, diamDep:_diamDep, cuarto:_svM.tipoCuarto});
