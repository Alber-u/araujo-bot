...
const _P5_REVISION = "Rev-19.95 28/06/2026";
...
function _p5paginaImpresoEmasesa(R, meta, saved){
  ...
  .p5emasesa .emrow{display:flex;align-items:baseline;margin:5px 0}
  .p5emasesa .emlbl{white-space:nowrap}
  .p5emasesa .emval{white-space:nowrap;padding:0 4px;font-weight:bold}
  .p5emasesa .emdots{flex:1;border-bottom:2px dotted #000;height:0;transform:translateY(-3px);margin:0 4px;min-width:18px}
  ...
  .p5emasesa .emfirma-l{text-align:center;margin:12px 0 2px}
