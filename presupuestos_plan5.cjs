...
const _P5_REVISION = "Rev-19.21 24/06/2026";
...
function _p5paginaImagenes(R, meta, cuadro, saved){
  ...
  var ETIQ = ["LLAVE DE ACERADO","PORTERO ELECTRONICO","CONTADOR","CATASTRO","ARMARIO CONTADOR","NUEVO ARMARIO","PEINE 1","PEINE 2","DISTRIBUCION","IMAGEN 10","IMAGEN 11"];
  ...
  for (var k = 0; k < 11; k++){
    ...
    var inner = idq
      ? ("<img class=\"p5img\" decoding=\"sync\" src=\"/plan5/imagen?id=" + idq + "&n=" + nn + tkq + "\" style=\"max-width:100%;max-height:100%;object-fit:contain;display:none\" onload=\"this.style.display='';var p=this.parentNode.querySelector('.p5ph');if(p)p.style.display='none';\" onerror=\"if(!this.dataset.fb){this.dataset.fb='1';this.src=window.__P5_NOIMG__;}else{this.style.display='none';}\"><span class=\"p5ph\" style=\"color:#b6c2d2;font-size:10px\">" + nn + ".png</span>")
  ...
  return "<div class=\"sheet p5imgs\">"
    ...
    + "<style>"
    + ".p5imgs .p5area{display:grid;grid-template-columns:repeat(5,1fr);grid-auto-flow:row;gap:6px;margin:6px 0 12px}.p5imgs .p5padbox{grid-column:1 / span 2;grid-row:1 / span 2;overflow:hidden}" + ".p5imgs .p5padron{width:100%;border-collapse:collapse;font-size:9px;table-layout:fixed;transform-origin:top left}"
