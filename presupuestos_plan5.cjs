...
const _P5_REVISION = "Rev-19.111 28/06/2026";
...
function _p5paginaImagenes(R, meta, cuadro, saved){
  ...
  if (!filas) filas = "<tr><td colspan=\"4\" style=\"text-align:center;color:#888\">(sin datos de catastro)</td></tr>";
  ...
  return "<div class=\"sheet p5imgs\">"
    ...
    + ".p5imgs .p5padron th{background:#1f3a8a;color:#fff;padding:1px 6px;text-align:center}"
    + ".p5imgs .p5padron td.cc{text-align:center}"
    + ".p5imgs .p5padron td{border:1px solid #cbd5e1;padding:0 4px;line-height:" + _padLH + "}"
    + ".p5imgs .p5padron td.pl{font-weight:700;text-align:right;word-break:break-word}"
    + ""
