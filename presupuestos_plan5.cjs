...
<style>
  :root{ --navy:#004079; }
  @page{
    size:A4; margin:32mm 14mm 18mm 14mm;
    @top-center{ content: element(dochead); width:100%; }
    @bottom-left{ content: string(np); font:10pt Cambria,Georgia,serif; color:var(--navy); border-top:1.6pt solid var(--navy); vertical-align:top; padding-top:2mm; }
    @bottom-center{ content:""; }
    @bottom-right{ content: counter(page); font:10pt Cambria,Georgia,serif; color:var(--navy); border-top:1.6pt solid var(--navy); vertical-align:top; padding-top:2mm; }
  }
  @page prod{ @top-center{ content: none; } }
  *{ box-sizing:border-box; }
  ...
  .dochead{ position: running(dochead); }
  .dochead .dhlogo{ height:17mm; width:auto; float:right; }
  .dochead .dhline{ clear:both; border-top:1.6pt solid var(--navy); margin-top:1mm; }
  .npset{ string-set: np content(); position:absolute; left:-9999px; top:0; }
  .sheet.prod{ page: prod; page-break-before:always; break-before:page; }
  @media print{
    body{ background:#fff; }
    .p5toolbar{ display:none; }
    .p5floatbar{ display:none!important; }
...
<script>window.PagedConfig={auto:true,after:function(){var o=document.querySelector(".p5toolbar");if(o){o.style.display="none";}var b=document.createElement("div");b.className="p5floatbar";b.style.cssText="position:fixed;top:0;left:0;right:0;z-index:99999;background:#004079;padding:8px 16px;text-align:right;box-shadow:0 2px 6px rgba(0,0,0,.3)";var t=document.createElement("button");t.type="button";t.textContent="Imprimir / Guardar PDF";t.style.cssText="font:600 14px Arial;background:#fff;color:#004079;border:0;border-radius:6px;padding:8px 16px;cursor:pointer";t.onclick=function(){window.print();};b.appendChild(t);document.body.appendChild(b);}};</script>
