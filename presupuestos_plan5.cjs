      ...
      if (m && m.nsum && m.tipo && (m.longCon != null && m.longCon !== "")) {
        ...
        R.desglose.forEach(function (l) {
          ...
          if (FK[l.concepto]) {
            ...
            if (rw) dato = { row: rw, valor: med.obra.conexion.factores[FK[l.concepto]], unidad: "ud/m" };
          }
          lineas.push({ concepto: nombre, cantidad: l.cantidad, precio: l.precio, parcial: l.total,
                        tipo: l.tipoCoste, capitulo_presupuesto: mm.capitulo_presupuesto || "", dato: dato });
        });
