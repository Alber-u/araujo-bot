...
const _P5_REVISION = "Rev-19.28 25/06/2026";
...
.fpsab{ position:absolute; right:5px; top:54%; transform:translateY(-50%); width:132px; height:auto; }
  ...
  .docfoot .dfnp{ font-size:14pt; color:var(--navy); padding-top:2px; position:relative; }
  .docfoot .dfpag{ font-size:10pt; color:var(--navy); float:right; }
  .docfoot .dfpag::after{ content:"Página " counter(page) " de " counter(pages); }
  @media print{
...
<div class="docfoot"><div class="dfline"></div><div class="dfnp">Presupuesto Nº ${_p5esc(np)||""}<span class="dfpag"></span></div></div>
