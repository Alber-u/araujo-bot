...
const _P5_REVISION = "Rev-19.77 27/06/2026";
...
function _p5paginaGrupoPresion(doc, comunidadTxt, encab, pie){
  ...
  var encabHtml = encab ? ('<div class="gpenc">'+_p5docBloque(encab, {}, "text-align:right")+'</div><div style="border-bottom:1px solid #333;margin:10px 0 26px"></div>') : "";
  var bodyHtml  = _p5docBloque(doc.cuerpo, repBody);
  var pieHtml   = pie ? ('<div style="margin-top:30px">'+_p5docBloque(pie, {fecha:_p5esc(_fechaHoy)})+'</div>') : "";
...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .gpdoc .legalp{ font-size:11.5pt; line-height:1.6; margin:0 0 14px; text-align:left; }
