...
function _p5memoria(R, meta, saved){
  ...
  var _ll = +m.llaves||0;
  var llaveTxt = _ll===1 ? "En la batería (1 ud)." : (_ll===2 ? "Una en la fachada y otra en la batería (2 uds)." : (_ll===3 ? "Una en la fachada y una en cada batería (3 uds)." : ""));
