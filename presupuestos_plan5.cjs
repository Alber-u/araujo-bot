...
const _P5_REVISION = "Rev-19.65 26/06/2026";
...
function _p5memoria(R, meta, saved){
  ...
  var armarioAlbTxt = (_b39==="EXISTENTE") ? "Se utilizará un <span style='color:#c00'>cuarto existente</span> para la batería de contadores." : (_b39==="ALUMINIO" ? "Se construirá un nuevo <span style='color:#c00'>armario de aluminio, con puertas de aluminio</span>, para la batería de contadores." : (_b39==="OBRA - P.ALUMINIO" ? "Se construirá un nuevo <span style='color:#c00'>armario de obra, con puertas de aluminio</span>, para la batería de contadores." : "Se construirá un nuevo <span style='color:#c00'>armario de obra, con puertas de hierro</span>, para la batería de contadores."));
