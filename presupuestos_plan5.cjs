...
const _P5_REVISION = "Rev-19.144 29/06/2026";
...
function _p5paginaDocumentacion(R, meta, cuadro, saved){
  ...
  return "<div class='sheet'>"
    ...
    + ".p5doc .acta{background:#f3f4f6;padding:10px 14px;margin:6px 0 2px;font-style:italic;color:#555;font-size:11pt;line-height:1.45;text-align:justify}"
    ...
    + "<li>Listado completo de Piso-Vecino-WhatsApp para gestionar la documentación.</li>"
