...
const _P5_REVISION = "Rev-19.142 29/06/2026";
...
function _p5paginaDocumentacion(R, meta, cuadro, saved){
  ...
  return "<div class='sheet'>"
    + "<style>"
    + ".p5doc .dtit{font-size:14pt;font-weight:800;color:#1f3a8a;margin:18px 0 4px}"
    + ".p5doc ol{margin:0;padding-left:22px}"
    + ".p5doc li{margin:0 0 11px;font-size:11pt;line-height:1.4;text-align:justify}"
    ...
    + ".p5doc .acta p{margin:0 0 11px}.p5doc .acta p:last-child{margin:0}"
    + "</style>"
    + "<div class='p5doc'>"
