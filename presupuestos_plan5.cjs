...
const _P5_REVISION = "Rev-19.31 25/06/2026";
...
function _p5paginaImagenes(R, meta, cuadro, saved){
  ...
  for (var k = 0; k < 11; k++){
    ...
    var inner = idq
      ? ("<img class=\"p5img\" decoding=\"sync\" src=\"/plan5/imagen?id=" + idq + "&n=" + nn + tkq + "\" style=\"width:100%;height:100%;object-fit:cover;border-radius:6px;display:none\" onload=\"this.style.display='';var p=this.parentNode.querySelector('.p5ph');if(p)p.style.display='none';\" onerror=\"if(!this.dataset.fb){this.dataset.fb='1';var box=this.parentNode;box.style.backgroundImage='url('+window.__P5_NOIMG__+')';box.style.backgroundSize='100% 100%';box.style.backgroundRepeat='no-repeat';this.style.display='none';var p=box.querySelector('.p5ph');if(p)p.style.display='none';var lab=box.parentNode.querySelector('.p5imglab');if(lab)lab.style.display='none';}else{this.style.display='none';}\"><span class=\"p5ph\" style=\"color:#b6c2d2;font-size:10px\">" + nn + ".png</span>")
