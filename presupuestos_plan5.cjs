...
.firma .fleft .fsello{ position:absolute; left:50%; top:50%; transform:translate(-50%,-50%); width:100px; height:auto; }
...
.fpsab{ position:absolute; right:5px; top:50%; transform:translateY(-50%); width:132px; height:auto; }
  ...
  .subv{ color:#000; line-height:1.28; }
  ...
  @media print{
    ...
    .sheet.subv{ min-height:228mm; }   /* 271(area) - 30(head) - ~9(foot); 1mm de margen para no desbordar */
...
module.exports = function (app) {
  ...
  app.get(["/plan5", "/plan5/toma-datos"], async function (req, res) {
    ...
    const html = TOMA_DATOS_HTML.replace("__PLAN5_REV__", _P5_REVISION)
