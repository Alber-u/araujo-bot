...
const _P5_REVISION = "Rev-19.25 24/06/2026";
...
<script>window.PagedConfig={auto:false};window.addEventListener("load",function(){try{var P=window.Paged;if(P&&P.Previewer){new P.Previewer().preview().then(function(){}).catch(function(e){console.error("paged:",e);});}}catch(e){console.error(e);}});</script>
