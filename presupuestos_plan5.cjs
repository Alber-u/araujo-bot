...
const _P5_REVISION = "Rev-19.79 27/06/2026";
...
function _p5paginaGrupoPresion(doc, comunidadTxt, encab, pie){
  ...
  var pieHtml   = pie ? ('<div style="margin-top:176px">'+_p5docBloque(pie, {fecha:_p5esc(_fechaHoy)})+'</div>') : "";
...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .gpdoc .gpenc .legalp{ font-size:13pt; margin:0 0 3px; line-height:1.45; text-align:right; }
