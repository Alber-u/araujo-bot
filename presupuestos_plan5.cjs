...
const _P5_CONDICIONES = "El presente presupuesto queda supeditado a las siguientes condiciones:\n- Que la batería de contadores quepa en la ubicación prevista.\n- La posibilidad técnica de paso de las instalaciones por el forjado sanitario.\n- La autorización de los propietarios de bajos y/o locales comerciales para el paso de las instalaciones a través de su propiedad.\n- La eliminación de ___ depósitos de los existentes para dar cabida a la/s batería/s de contadores.\n- La legalidad del piso ___ que no aparece en Catastro.\n- La autorización por parte de EMASESA para conectar en el punto actual de suministro; en caso de que obligue a conectar en otro punto distinto, el presupuesto deberá ser revisado.\n\nEn caso de que los buzones estorben para la colocación del armario de la batería, estos se desmontarán, siendo responsabilidad de la CCPP su nueva adquisición y montaje en otra ubicación.";
...
function _p5paginasLegales(meta, cuadro, condiciones){
  ...
  ${ (condiciones && condiciones.trim()) ? '<div class="condpart">'+_p5esc(condiciones)+'</div>' : '' }<table class="firma"><tbody>
    <tr>
      <td class="fleft">
...
.condpart{ color:#c00; white-space:pre-line; line-height:1.3; margin:4px 0 10px; }
