...
const _P5_REVISION = "Rev-19.107 28/06/2026";
...
function _p5paginaImagenes(R, meta, cuadro, saved){
  ...
  var _padLH = 0.9;  // <-- interlineado del padron (altura de fila). Subir/bajar a mano.
  var sv = saved || {};
  ...
  return "<div class=\"sheet p5imgs\">"
    ...
    + ".p5imgs .p5padron td{border-left:1px solid #cbd5e1;border-right:1px solid #cbd5e1;padding:0 4px;line-height:" + _padLH + "}"
    ...
    + "</style>"
    + "<div class=\"p5area\">" + "<div class=\"p5padbox\"><table class=\"p5padron\"><colgroup><col style=\"width:46%\"><col style=\"width:22%\"><col style=\"width:16%\"><col style=\"width:16%\"></colgroup><thead><tr><th>" + (_p5esc(cab) || "CATASTRO") + "</th><th>USO</th><th>SUP. m&#178;</th><th>BAT</th></tr></thead><tbody>" + filas + "</tbody></table></div>"
    + celdas
    + "</div>"
    + "</div>"
    + "";
