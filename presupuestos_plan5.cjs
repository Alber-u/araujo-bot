...
const _P5_REVISION = "Rev-19.106 28/06/2026";
...
function _p5paginaImagenes(R, meta, cuadro, saved){
  var f = (R && R.finca) || {};
  var _padFS = 9.5;   // <-- TAMANO DE LETRA del padron (px). Subir/bajar a mano hasta que quede bien.
  var _padLH = 1;  // <-- interlineado del padron (altura de fila). Subir/bajar a mano.
  var sv = saved || {};
