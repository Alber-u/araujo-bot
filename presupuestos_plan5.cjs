...
const _P5_REVISION = "Rev-19.22 24/06/2026";
...
function _p5paginaImagenes(R, meta, cuadro, saved){
  ...
  return "<div class=\"sheet p5imgs\">"
    ...
    + "<style>"
    + ".p5imgs .p5area{display:grid;grid-template-columns:repeat(5,1fr);grid-auto-flow:row;column-gap:6px;row-gap:14px;margin:6px 0 12px}.p5imgs .p5padbox{grid-column:1 / span 2;grid-row:1 / span 2;overflow:hidden}" + ".p5imgs .p5padron{width:100%;border-collapse:collapse;font-size:9px;table-layout:fixed;transform-origin:top left}"
