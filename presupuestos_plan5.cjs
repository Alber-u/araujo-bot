...
//   * La Y (menor) la manda el MOTOR (Claude). Sube de uno en uno SOLO cuando cambian los
//     CALCULOS de este archivo (presupuestos_plan5): baterias, subvencion, comunero, precios,
//     cantidades, formulas del motor. Los cambios que NO tocan calculos (interfaz, mapa, textos,
//     PWA, cierre/visual, etc.) NO suben la version.
...
function _p5memoria(R, meta, saved){
  ...
  <p class="meml"><b>CONTADOR:</b><br>El contador${vgid("ac_ncont")?(" (nº "+_p5esc(vgid("ac_ncont"))+")"):""} está ubicado en ${_p5esc((vgid("ac_ubic")||"zonas comunes").toLowerCase())} del edificio.</p>
