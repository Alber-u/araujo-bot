...
<script>window.addEventListener("load",function(){var s=document.querySelector(".p5doc");if(s&&window.PagedPolyfill){window.PagedPolyfill.preview(s,[],document.body).then(function(){s.remove();});}});</script>
</body>
</html>`;
}
