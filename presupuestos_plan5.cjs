...
const _P5_REVISION = "Rev-19.81 27/06/2026";
...
function _p5paginaGrupoPresion(doc, comunidadTxt, encab, pie){
  ...
  var repBody = {
    ...
    "nif_comunidad": _p5lineaRellenar(200),
    "presidente": _p5lineaRellenar(540),
    "nif_presidente": _p5lineaRellenar(200)
  };
  ...
  var bodyHtml  = '<div class="gpbody">'+_p5docBloque(doc.cuerpo, repBody)+'</div>';
  var pieHtml   = pie ? ('<div style="margin-top:360px">'+_p5docBloque(pie, {fecha:_p5esc(_fechaHoy)})+'</div>') : "";
...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .gpdoc .legalp{ font-size:16pt; line-height:1.9; margin:0 0 16px; text-align:left; }
  .gpdoc .gpenc .legalp{ margin:0 0 3px; line-height:1.45; text-align:right; }
  .gpdoc .gpbody .legalp:nth-child(1){ margin-bottom:34px; }   /* tras "Yo, D/Dª...": mas aire */
  .gpdoc .gpbody .legalp:nth-child(2){ margin-bottom:8px; }    /* tras "como presidente...": menos */
  .gpdoc .gpbody .legalp:last-child{ margin-bottom:0; }        /* el gran hueco lo da el pie */
