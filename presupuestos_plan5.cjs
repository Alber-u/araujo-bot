...
const _P5_REVISION = "Rev-19.94 28/06/2026";
...
function _p5paginaImpresoEmasesa(R, meta, saved){
  ...
  .p5emasesa .embar .emsub{font-weight:normal;color:#555;font-size:10px}
  ...
  <div class="embox">
    ...
    <div class="emsec" style="border-top:none">
      ...
      <div class="emrow"><span class="emlbl">Piso:</span><span class="emdots" style="flex:0 0 70px"></span><span class="emlbl">Población:</span><span class="emdots"></span><span class="emlbl">Teléfono (fijo):</span><span class="emdots"></span><span class="emlbl">Móvil:</span><span class="emdots" style="flex:0 0 110px"></span></div>
      ...
      <div class="emchk"><span class="emcb"></span><span><b>No entrega Certificado de empadronamiento.</b> La facturación de consumo se realizará teniendo en cuenta <b class="emu">0 hab.</b></span></div>
      <div class="emnota"><b class="emu">NOTA IMPORTANTE</b>: El art. 2.1 de la Ordenanza Reguladora del Servicio dispone que <i>"El nº de habitantes por vivienda deberá ser acreditado mediante inscripción del titular del suministro en el Padrón Municipal del Ayuntamiento correspondiente. Las modificaciones en más o en menos del nº de habitantes de la vivienda deberán ser notificadas a EMASESA por la persona usuaria en el momento en que se produzcan, siendo responsabilidad del mismo tener actualizado los datos en el Padrón Municipal y en Emasesa. La notificación a EMASESA de la actualización de los datos del nº de habitantes […] no tendrá efectos retroactivos, por lo que comenzará a generar efectos a partir de la primera factura que se emita con posterioridad a la presentación de la solicitud, acompañada de la documentación acreditativa del cumplimiento de los requisitos.</i></div>
  ...
  <div class="emfirma-r">Firma del solicitante</div>
  <div class="emlegal">
