...
const _P5_REVISION = "Rev-19.76 27/06/2026";
...
function _p5paginaGrupoPresion(doc, comunidadTxt, encab, pie){
  ...
  var encabHtml = encab ? (_p5docBloque(encab, {}, "text-align:right;margin:0 0 2px")+'<div style="border-bottom:1px solid #333;margin:6px 0 16px"></div>') : "";
  var bodyHtml  = _p5docBloque(doc.cuerpo, repBody);
  var pieHtml   = pie ? ('<div style="margin-top:18px">'+_p5docBloque(pie, {fecha:_p5esc(_fechaHoy)})+'</div>') : "";
