...
const _P5_REVISION = "Rev-19.11 24/06/2026";
...
<div class="p5toolbar">
  ...
  <button class="p5btn" onclick="p5imprimir()">&#128424; Imprimir / Guardar PDF</button><script>function p5imprimir(){var L=[].slice.call(document.querySelectorAll('.p5img'));var P=L.filter(function(i){return !i.complete;});if(!P.length){window.print();return;}var b=document.querySelector('.p5btn');if(b){b.disabled=true;b.textContent='Cargando fotos...';}var d=0;P.forEach(function(i){var f=function(){d++;if(d>=P.length){if(b){b.disabled=false;b.innerHTML='&#128424; Imprimir / Guardar PDF';}window.print();}};i.addEventListener('load',f);i.addEventListener('error',f);});}</script>
</div>
