      ...
      if (!sirviendoFoto && m && m.nsum && m.tipo && (m.longCon != null && m.longCon !== "")) {
        ...
        try {
          ...
          cuadro = {
            ...
            fin6: (_fin[0] && _fin[0].cuota) || 0, fin12: (_fin[1] && _fin[1].cuota) || 0, fin18: (_fin[2] && _fin[2].cuota) || 0, finCom: finanComunitaria(R.totales.conSubvencion).importe, finComPct: finanComunitaria(R.totales.conSubvencion).pct,
