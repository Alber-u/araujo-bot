...
// Nombre que se IMPRIME para ciertas partidas (por nº, no por texto): garantiza el nombre
// correcto en el PDF sin depender del Sheet ni del motor (incluye presupuestos ya cerrados).
const _P5_NOM_IMPRESION = { "1.3.2":"Juego de llaves de escuadra", "2.5":"Falsos techos/vigas de escayola" };
...
function _p5tablaPresupuesto(dsg, cuadro, matX){
  ...
  function filaLinea(r){
    return '<tr class="ln"><td class="den">'+_p5esc(r.num)+' '+_p5esc(_P5_NOM_IMPRESION[r.num]||r.nombre)+'</td>'+celdasLinea(r)+'</tr>';
  }
...
const _P5_REVISION = "Rev-19.87 28/06/2026";
