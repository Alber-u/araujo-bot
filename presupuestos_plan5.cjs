...
function parseMediciones(values, ovDato) {
  ...
  const obra = { conexion: {
    ...
    tiempoAlb: [   // Albanil: independiente; por defecto = dias de Fontanero, override por obra aparte
      { hasta: 1.5, dias: fb(g("Albañil (tubo conexión)", "Tramo 1 · días"), fb(g("Fontanero (tubo conexión)", "Tramo 1 · días"), 0.25)) },
      { hasta: 4,   dias: fb(g("Albañil (tubo conexión)", "Tramo 2 · días"), fb(g("Fontanero (tubo conexión)", "Tramo 2 · días"), 0.375)) },
      { hasta: 10,  dias: fb(g("Albañil (tubo conexión)", "Tramo 3 · días"), fb(g("Fontanero (tubo conexión)", "Tramo 3 · días"), 1)) },
      { hasta: 20,  dias: fb(g("Albañil (tubo conexión)", "Tramo 4 · días"), fb(g("Fontanero (tubo conexión)", "Tramo 4 · días"), 2)) },
    ],
