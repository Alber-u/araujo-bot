...
let getThemeCss; try { ({ getThemeCss } = require("./estilo-visual.cjs")); } catch (e) { getThemeCss = () => ""; }
...
module.exports = function (app) {
  ...
  app.get(["/plan5", "/plan5/toma-datos"], async function (req, res) {
    ...
    const html = TOMA_DATOS_HTML
      .replace("<!--__PLAN5_THEME__-->", theme ? "<style>" + theme + "</style>" : "")
