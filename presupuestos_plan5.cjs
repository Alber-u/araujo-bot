...
const _P5_REVISION = "Rev-19.123 28/06/2026";
...
function _p5paginaImagenes(R, meta, cuadro, saved){
  ...
  var _padWdir = 60;  // <-- ancho columna DIRECCION (%)
  var _padWuso = 20;  // <-- ancho columna USO (%)
  var _padWsup = 10;  // <-- ancho columna SUP. m2 (%)
  var _padWbat = 10;  // <-- ancho columna BAT (%)   (los cuatro deben sumar 100)
