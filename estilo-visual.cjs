...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-info{flex:0 0 auto;min-width:0;width:280px;display:flex;align-items:baseline;gap:6px;overflow:hidden}
    ...
    .ptl-fila-importe{font-size:12px;font-weight:600;font-variant-numeric:tabular-nums;color:var(--ptl-gray-500);flex-shrink:0;min-width:110px;text-align:right}
    .ptl-fila-badge-slot{flex:0 0 auto;min-width:130px;display:flex;justify-content:flex-end;align-items:center}
    .ptl-fila .ptl-timeline{flex:0 0 auto;min-width:0;justify-content:flex-end;padding:0;overflow:hidden}
