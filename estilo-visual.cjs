...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-badge-slot{flex:0 0 125px;width:125px;display:inline-block;text-align:center;min-width:0;padding-right:0}
    ...
    .ptl-fila-badge-fijo{flex:0 0 125px;width:125px;display:inline-block;text-align:center}
