...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    /* ===== Filas de lista ===== */
    .ptl-fila{background:var(--ptl-azul-oscuro);border:1px solid var(--ptl-azul-claro);border-radius:8px;padding:3px 12px;margin-bottom:3px;display:flex;align-items:center;gap:8px;color:var(--ptl-azul-claro);transition:all .15s}
    ...
    .ptl-fila-info{flex:0 0 200px;min-width:0;max-width:200px;display:flex;align-items:baseline;gap:6px;overflow:hidden}
    ...
    .ptl-fila-importe{font-size:12px;font-weight:600;font-variant-numeric:tabular-nums;color:var(--ptl-azul-claro);flex-shrink:0;min-width:70px;text-align:right;margin-left:auto}
    .ptl-fila-badge-slot{flex:0 0 130px;min-width:0;display:flex;justify-content:flex-end;align-items:center;padding-right:10px}
    .ptl-fila .ptl-timeline{flex:0 0 auto;width:auto;justify-content:flex-end;padding:0;overflow:visible}
