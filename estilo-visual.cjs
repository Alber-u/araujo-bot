// estilo-visual.cjs
// Build: 2026-05-24 v1.16 (Sobre v1.15: las clases de feedback de guardado .ptl-guardado-ok / .ptl-guardado-error ahora también RELLENAN el fondo del campo (background-color con el tono claro --ptl-success-light / --ptl-danger-light), no solo el borde. Antes solo se veía el borde verde/rojo; ahora el recuadro entero se tiñe en suave, manteniendo el texto negro legible. Resto igual que v1.15.)
