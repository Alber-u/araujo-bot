...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-info{flex:0 0 185px;min-width:0;max-width:185px;display:flex;align-items:baseline;gap:6px;overflow:hidden;margin-right:10px}
    ...
    .ptl-fila-importe{font-size:12px;font-weight:600;font-variant-numeric:tabular-nums;color:var(--ptl-azul-claro);flex-shrink:0;min-width:70px;text-align:right;padding-left:16px}
    .ptl-fila-badge-slot{flex:0 0 130px;min-width:0;display:flex;justify-content:flex-end;align-items:center;padding-right:0}
    .ptl-fila .ptl-timeline{flex:1 1 auto;width:auto;justify-content:flex-start;padding:0;overflow:hidden}
