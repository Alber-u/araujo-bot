...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-info{flex:0 0 220px;min-width:0;max-width:220px;display:flex;align-items:baseline;gap:6px;overflow:hidden;margin-right:0}
    ...
    .ptl-fila-badge-slot{flex:0 0 90px;min-width:0;display:flex;justify-content:flex-end;align-items:center;padding-right:0}
