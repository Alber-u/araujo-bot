...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-badge-slot{flex:0 0 150px;width:150px;display:inline-block;text-align:center;min-width:0;padding-right:0}
    .ptl-fila .ptl-timeline{flex:1 1 0;width:auto;min-width:0;justify-content:flex-end;padding:0;overflow:visible}
    .ptl-fila-badge{font-size:10px;font-weight:700;padding:2px 3px;border-radius:999px;flex-shrink:0;letter-spacing:.2px;line-height:1.2;white-space:nowrap;box-sizing:border-box;width:150px;display:inline-block;text-align:center;overflow:hidden;text-overflow:ellipsis}
    ...
    .ptl-fila-badge-fijo{flex:0 0 150px;width:150px;display:inline-block;text-align:center}
