// estilo-visual.cjs
// Build: 2026-05-24 v1.15 (Sobre v1.14: NUEVAS 2 clases compartidas de feedback de guardado por campo: .ptl-guardado-ok (borde verde + halo, var --ptl-success) y .ptl-guardado-error (borde rojo + halo, var --ptl-danger). Se aplican al recuadro donde se escribe (input/textarea/select). Usan !important para ganar a los border inline de algunos campos. La LÓGICA (cuándo poner/quitar la clase, verde 5s, rojo permanente) vive en presupuestos.cjs y documentacion.cjs; aquí solo el aspecto, en un único sitio para todo el programa. Acompaña a presupuestos.cjs (helper ptlFlashGuardado en ptlGuardarCampo, píldora global jubilada visualmente) y documentacion.cjs v17.28 (_flashGuardado pasa a usar estas clases, verde de 2s a 5s).)
...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-vec-fila.ptl-vec-fila-expandida{background:#93C5FD;box-shadow:inset 4px 0 0 var(--ptl-brand)}
    ...
    .ptl-vec-acordeon-fila{background:#93C5FD;box-shadow:inset 4px 0 0 var(--ptl-brand)}
    ...
    */
    ...
    .ptl-guardado-ok{border-color:var(--ptl-success) !important;box-shadow:0 0 0 2px var(--ptl-success-light)}
    .ptl-guardado-error{border-color:var(--ptl-danger) !important;box-shadow:0 0 0 2px var(--ptl-danger-light)}
  `;
}
