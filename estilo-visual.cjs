...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-info{flex:1 1 0;min-width:0;display:flex;align-items:baseline;gap:6px;overflow:hidden}
    ...
    .ptl-fila-badge-slot{flex:0 0 130px;display:flex;justify-content:flex-end;align-items:center}
