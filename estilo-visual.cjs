...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-info{flex:0 0 140px;min-width:0;max-width:140px;display:flex;align-items:baseline;gap:6px;overflow:hidden;margin-right:10px}
    ...
    .ptl-fila .ptl-timeline{flex:1 1 auto;width:auto;justify-content:flex-start;padding:0;overflow:visible}
