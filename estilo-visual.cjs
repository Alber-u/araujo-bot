...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-badge-slot{flex:1 1 auto;min-width:0;display:flex;justify-content:flex-end;align-items:center;padding-right:14px}
    .ptl-fila .ptl-timeline{flex:0 0 auto;justify-content:flex-end;padding:0;overflow:visible}
