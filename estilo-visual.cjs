...
function getThemeCss() {
  return `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .ptl-fila-info{flex:0 0 130px;min-width:0;max-width:130px;display:flex;align-items:baseline;gap:6px;overflow:hidden;margin-right:0}
    ...
    .ptl-fila-importe{font-size:12px;font-weight:600;font-variant-numeric:tabular-nums;color:var(--ptl-azul-claro);flex:0 0 80px;width:80px;text-align:right;padding-left:0;padding-right:0}
